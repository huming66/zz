			...
			if (!this.bound && resizable) {
				...
				$(document).mouseup(function () {
					...
					if (isClickedSep) {
						...
						width = parseFloat(toResize.css("width"))  //mhu
						ref._tableSettings.columns[colNum].width = width; //mhu
						...
						// mhu width = ref._tableSettings.columns[colNum].width = parseFloat(toResize.css("width"));
						isClickedSep = false;
						toResize = null;
