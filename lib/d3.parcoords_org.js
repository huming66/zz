...
d3.parcoords = function(config) {
  ...
  var pc = function(selection) {
    ...
    __.height = selection[0][0].clientHeight-10; //hm
  ...
  pc.autoscale = function() {
    ...
    var defaultScales = {
      ...
      "string": function(k) {
        ...
        // domain = Object.getOwnPropertyNames(counts).sort(function(a, b) {  //hmhm org sort by count
        //   return counts[a] - counts[b];
        // });

        domain = Object.getOwnPropertyNames(counts).sort(function(a, b) {    //hmhm sorting by string 
